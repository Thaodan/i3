...
static bool handle_wm_pid_change(Con *con, xcb_get_property_reply_t *prop) {
    window_update_wm_pid(con->window, prop);
...
static struct property_handler_t property_handlers[] = {
    ...
    {0, UINT_MAX, handle_wm_pid_change}};
...
void property_handlers_init(void) {
    ...
    property_handlers[14].atom = A__NET_WM_PID;
}
